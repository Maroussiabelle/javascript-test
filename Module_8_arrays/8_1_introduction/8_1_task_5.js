...
а затем элементы массива по одному соответствующее количество раз.
 Программа добавляет каждый элемент, введенный пользователем,
 в конец массива. Далее, с помощью цикла for...of в массив lengths поочерёдно
  добавляются длина каждого элемента массива userArray.
...
for (let i = 0; i < numElements; i++) {
    const word = prompt("Введите элемент массива:");
    userArray.push(word);
}
